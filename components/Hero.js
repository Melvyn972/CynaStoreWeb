...
const Hero = () => {
  return (
    <section className="relative w-full min-h-[120vh] flex flex-col items-center justify-center overflow-hidden ios-hero-section pb-32">
      {/* Fond animé avec dégradés iOS 16 */}
      <div className="absolute inset-0 bg-gradient-to-br from-black via-gray-950 to-purple-950/50"></div>
      ...
      <div className="absolute inset-0 opacity-30 z-10">
        ...
        <div className="absolute top-1/3 right-1/3 w-2 h-2 bg-indigo-400 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
        <div className="absolute bottom-1/3 left-1/3 w-2.5 h-2.5 bg-purple-300 rounded-full animate-pulse" style={{animationDelay: '3s'}}></div>
        <div className="absolute bottom-1/4 right-1/4 w-2 h-2 bg-indigo-300 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-1/6 left-1/5 w-1.5 h-1.5 bg-purple-200 rounded-full animate-pulse" style={{animationDelay: '4s'}}></div>
        <div className="absolute bottom-1/5 right-1/5 w-1.5 h-1.5 bg-indigo-200 rounded-full animate-pulse" style={{animationDelay: '5s'}}></div>
      </div>
      ...
      <div className="relative z-10 ios-container px-6 md:px-10 text-center ios-fade-in">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-20 ios-slide-up" style={{animationDelay: '0.6s'}}>
          ...
          <Link 
            href="#features" 
            className="hero-btn ios-glass-light text-white/90 hover:text-white hover:bg-white/20 group"
          >
        ...
        <div className="relative max-w-6xl mx-auto ios-slide-up" style={{animationDelay: '1s'}}>
          ...
          <div className="absolute -top-6 -left-6 w-12 h-12 ios-glass rounded-2xl flex items-center justify-center ios-float group hover:scale-110 transition-transform duration-300 z-30">
            <svg className="w-6 h-6 text-purple-400 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="absolute bottom-16 left-1/2 transform -translate-x-1/2 ios-fade-in z-20" style={{animationDelay: '1.5s'}}>
        <div className="flex flex-col items-center gap-3 text-white/60 hover:text-white/80 transition-colors cursor-pointer group">
          ...
          <div className="p-3 rounded-full ios-glass-light group-hover:bg-white/20 transition-all duration-300">
            <svg className="w-6 h-6 animate-bounce group-hover:text-purple-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
