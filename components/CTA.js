const CTA = () => {
  return (
    <section className="relative overflow-hidden ios-bg-dark py-24 lg:py-36">
      {/* Effets de lumière flottants */}
      <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-purple-500/20 blur-3xl animate-float"></div>
      <div className="absolute -bottom-40 -left-40 w-80 h-80 rounded-full bg-indigo-500/15 blur-3xl animate-float" style={{animationDelay: '2s'}}></div>
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 rounded-full bg-purple-400/10 blur-3xl animate-float" style={{animationDelay: '4s'}}></div>
      ...
      <div className="ios-container px-6 md:px-10 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-16 ios-fade-in">
          ...
          <h2 className="ios-title text-white mb-6 leading-tight">
            Protégez votre entreprise contre les <span className="bg-gradient-to-r from-purple-400 to-indigo-400 bg-clip-text text-transparent">menaces cyber</span> en évolution
          </h2>
          <p className="ios-body text-xl text-white/80 mb-10 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 max-w-3xl mx-auto ios-slide-up" style={{animationDelay: '0.2s'}}>
          ...
          <a href="#" className="w-full md:w-auto px-8 py-4 ios-glass-light hover:bg-white/20 text-white transition-all rounded-full font-medium text-center group hover:scale-105">
            Commencer
          </a>
        </div>
        
        <div className="mt-24 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10 text-center ios-slide-up" style={{animationDelay: '0.4s'}}>
          <div className="ios-card group hover:scale-105 transition-all duration-300">
            <div className="w-12 h-12 mx-auto mb-4 flex items-center justify-center rounded-full bg-gradient-to-br from-purple-500/20 to-purple-500/10 group-hover:scale-110 transition-transform duration-300">
            ...
            <p className="text-white/70 text-sm">Interface intuitive conçue pour tous les niveaux</p>
          </div>
          
          <div className="ios-card group hover:scale-105 transition-all duration-300">
            <div className="w-12 h-12 mx-auto mb-4 flex items-center justify-center rounded-full bg-gradient-to-br from-indigo-500/20 to-indigo-500/10 group-hover:scale-110 transition-transform duration-300">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-white/70 text-sm">Soyez informé immédiatement de toute menace</p>
          </div>
          
          <div className="ios-card group hover:scale-105 transition-all duration-300">
            <div className="w-12 h-12 mx-auto mb-4 flex items-center justify-center rounded-full bg-gradient-to-br from-green-500/20 to-green-500/10 group-hover:scale-110 transition-transform duration-300">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-white/70 text-sm">Protégez vos données avec le chiffrement avancé</p>
          </div>
          
          <div className="ios-card group hover:scale-105 transition-all duration-300">
            <div className="w-12 h-12 mx-auto mb-4 flex items-center justify-center rounded-full bg-gradient-to-br from-yellow-500/20 to-yellow-500/10 group-hover:scale-110 transition-transform duration-300">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-white/70 text-sm">Une équipe d&apos;experts à votre service en permanence</p>
          </div>
        </div>
      </div>
    </section>
