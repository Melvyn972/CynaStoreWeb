...
const Problem = () => {
  return (
    <section className="relative ios-bg-dark text-white py-24 md:py-32 overflow-hidden">
      ...
      <div className="ios-container px-6 md:px-10 relative z-10">
        <div className="max-w-3xl mb-16 md:mb-24 ios-fade-in">
          ...
          <h2 className="ios-title mb-8 leading-tight">
            83% des entreprises font face à des <span className="bg-gradient-to-r from-purple-400 to-indigo-400 bg-clip-text text-transparent">pertes financières</span> dues à une sécurité inadéquate
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10 ios-slide-up" style={{animationDelay: '0.2s'}}>
          <ProblemCard 
            number="01"
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 mt-16 max-w-5xl mx-auto">
            <div className="flex items-center gap-6 ios-glass rounded-2xl p-6 group hover:scale-105 transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-white/70">Entreprises protégées</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 ios-glass rounded-2xl p-6 group hover:scale-105 transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-white/70">Taux de détection</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 ios-glass rounded-2xl p-6 group hover:scale-105 transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-white/70">Temps de réponse moyen</p>
              </div>
            </div>
          </div>
        </div>
