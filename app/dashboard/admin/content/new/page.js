...
export default function NewContentBlock() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.message || 'Échec de la création du bloc de contenu');
      }
  ...
  const needsImage = ['image', 'text_image', 'hero'].includes(formData.blockType);
      ...
      <div className="ios-container space-y-8 relative z-20">
        ...
        <div className="flex items-center justify-between ios-fade-in">
          ...
          <div>
            ...
            <p className="ios-body mt-2">
              Créez un nouveau bloc de contenu pour vos pages
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {needsImage && (
            <div className="dashboard-card">
              <h2 className="text-xl font-semibold text-white flex items-center gap-3 mb-6">
                ...
                Image du bloc
                {formData.blockType === 'image' ? ' *' : ' (optionnel)'}
              </h2>
                  ...
                  {imagePreview ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-emerald-500 to-teal-500 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-white/70 text-sm">Choisissez une image pour ce bloc</p>
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex flex-col gap-3">
                    <input
                      ...
                      accept="image/*"
                      className="hidden"
                      required={formData.blockType === 'image'}
                    />
                    <button
                      type="button"
          ...
          <div className="flex justify-end gap-4">
            ...
            <button
              type="submit"
              disabled={loading || !formData.title || !formData.content || (needsImage && formData.blockType === 'image' && !selectedFile)}
